...
def model_payload(item: Any, *, include_schema: bool = False) -> dict[str, Any]:
    payload: dict[str, Any] = {
        ...
        "provider_id_verified": item.provider_id_verified,
        "schema_verified": item.schema_verified,
        "enabled_for_submission": item.enabled_for_submission,
        "tested_live": item.tested_live,
