...
export function TabNav() {
  ...
  return (
    <nav aria-label="Основная навигация" className="fixed bottom-0 left-0 right-0 z-50 px-2 sm:px-3 lg:px-4">
              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'relative flex min-w-[66px] flex-1 flex-col items-center justify-center gap-1 rounded-[15px] px-2 py-2',
                  ...
                  >
                    ...
                    <span className="text-[11px] font-semibold tracking-[-0.01em]">{tab.label}</span>
                  </button>
                )
              })}
            </div>
